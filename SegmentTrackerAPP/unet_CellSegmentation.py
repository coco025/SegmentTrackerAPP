...
#print("##################", os.getcwd())
weights_path = os.getcwd() + '/weights/' + settings.WEIGHTS_DIR
pred_dir = 'preds\\'
...
def predict_web(directorio_entrada, directorio_salida, test_id):
    """
    ...
    for image_pred, index in zip(imgs_mask_predict, range(x_test.shape[0])):
        ...
        fnt = ImageFont.truetype(os.getcwd()+'/fonts/arial.ttf', 16)
